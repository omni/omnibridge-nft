...
contract SelectorTokenGasLimitManager is OwnableModule {
     ...
     * - deployAndHandleBridgedNFT, deployAndHandleBridgedNFTAndCall
     * - handleBridgedNFT, handleBridgedNFTAndCall
     * - handleNativeNFT, handleNativeNFTAndCall
     * - fixFailedMessage
     * Only the owner can call this method.
     */
    function setCommonRequestGasLimits(uint256[] calldata _gasLimits) external onlyOwner validGasLimits(7, _gasLimits) {
        ...
        selectorGasLimit[BasicNFTOmnibridge.deployAndHandleBridgedNFTAndCall.selector] = _gasLimits[1];
        selectorGasLimit[BasicNFTOmnibridge.handleBridgedNFT.selector] = _gasLimits[2];
        selectorGasLimit[BasicNFTOmnibridge.handleBridgedNFTAndCall.selector] = _gasLimits[3];
        selectorGasLimit[BasicNFTOmnibridge.handleNativeNFT.selector] = _gasLimits[4];
        selectorGasLimit[BasicNFTOmnibridge.handleNativeNFTAndCall.selector] = _gasLimits[5];
        ...
        validGasLimits(2, _gasLimits)
    {
        ...
        selectorTokenGasLimit[BasicNFTOmnibridge.handleNativeNFTAndCall.selector][_token] = _gasLimits[1];
    }
        ...
        validGasLimits(4, _gasLimits)
    {
        ...
        selectorTokenGasLimit[BasicNFTOmnibridge.deployAndHandleBridgedNFTAndCall.selector][_token] = _gasLimits[1];
        selectorTokenGasLimit[BasicNFTOmnibridge.handleBridgedNFT.selector][_token] = _gasLimits[2];
        selectorTokenGasLimit[BasicNFTOmnibridge.handleBridgedNFTAndCall.selector][_token] = _gasLimits[3];
    }
}
