...
const { EternalStorageProxy, ForeignNFTOmnibridge, ERC1155BridgeToken } = require('../loadContracts')
const { FOREIGN_ERC1155_TOKEN_IMAGE, FOREIGN_TOKEN_NAME_SUFFIX } = require('../loadEnv')
