...
${FLATTENER} ${BRIDGE_CONTRACTS_DIR}/omnibridge_nft/components/bridged/ERC1155TokenProxy.sol > flats/ERC1155TokenProxy_flat.sol
${FLATTENER} ${BRIDGE_CONTRACTS_DIR}/omnibridge_nft/modules/gas_limit/SelectorTokenGasLimitManager.sol > flats/SelectorTokenGasLimitManager_flat.sol
...
${FLATTENER} ${TOKEN_CONTRACTS_DIR}/ERC1155BridgeToken.sol > flats/ERC1155BridgeToken_flat.sol
