...
${FLATTENER} ${BRIDGE_CONTRACTS_DIR}/omnibridge_nft/modules/forwarding_rules/MultiTokenForwardingRulesManager.sol > flats/MultiTokenForwardingRulesManager_flat.sol
